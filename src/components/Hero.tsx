  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div 
        ...
        style={{ backgroundImage: `url(${heroPcb})` }}
      >
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center text-white">
          ...
          <h1 className="text-5xl md:text-7xl font-bold mb-6 leading-tight">
            Get Your <span className="text-tech-green">PCB Boards</span>
            <br />
            in Just <span className="text-tech-green">2 Days!</span>
          </h1>

          <p className="text-xl md:text-2xl mb-8 text-gray-200 max-w-3xl mx-auto leading-relaxed">
            India's fastest PCB design & manufacturing company. From concept to delivery – 
            we make it happen with lightning speed and uncompromising quality.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
            ...
            <Button 
              variant="outline" 
              size="lg"
              className="border-white text-white hover:bg-white hover:text-deep-blue px-8 py-6 text-lg font-semibold"
            >
              Get Free Quote
            </Button>
          </div>
      ...
      <div className="absolute bottom-0 left-0 w-full h-32 opacity-20">
        <svg className="w-full h-full" viewBox="0 0 1200 100">
          ...
          <path 
            ...
            fill="none" 
            strokeWidth="1"
            className="text-tech-green/50 animate-pulse"
